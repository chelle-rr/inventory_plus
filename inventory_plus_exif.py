...
def get_exif_data(file_path):
    ...
    try:
        with Image.open(file_path) as img:
            ...
            exif_fields["artist"] = exif_data.get("Artist")
            exif_fields["copyright"] = exif_data.get("Copyright")
            exif_fields["datetimeoriginal"] = exif_data.get("DateTimeOriginal")
            exif_fields["imagedescription"] = exif_data.get("ImageDescription")
