...
def get_exif_data(file_path):
    ...
    try:
        ...
        if metadata and len(metadata) > 0:
            ...
            exif_fields["artist"] = md.get("Artist")
            exif_fields["copyright"] = md.get("Copyright")
            exif_fields["datetimeoriginal"] = md.get("DateTimeOriginal")
            exif_fields["imagedescription"] = md.get("ImageDescription")
